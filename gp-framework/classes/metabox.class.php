...
class GPFramework_Metabox extends GPFramework_Abstract{
        ...
        echo '<div class="gp-content">';
          ...
          foreach( $sections as $val ) {
            ...
            if( isset( $val['fields'] ) ) {
              ...
              echo '<div id="gp-tab-'. $val['name'] .'" class="gp-section"'. $active_content .'>';
              echo ( isset( $val['title'] ) ) ? '<div class="gp-section-title"><h3>'. $val['title'] .'</h3></div>' : '';
  ...
  public function save_post( $post_id, $post ) {
	//pree($post_id);pree($post);pree($_POST);exit;
          ...
          if( isset( $section['fields'] ) ) {
            ...
            foreach( $section['fields'] as $field ) {
              ...
              if( isset( $field['type'] ) && isset( $field['id'] ) ) {
                ...
                if( has_filter( 'gp_sanitize_'. $sanitize_type ) ) {
