 ...
 *
 */
class GPFramework_Customize extends GPFramework_Abstract {
  ...
  public function __construct( $options ) {
    ...
    $this->options = apply_filters( 'gp_customize_options', $options );
  ...
  public static function instance( $options = array() ){
    if ( is_null( self::$instance ) && gp_ACTIVE_CUSTOMIZE ) {
  ...
  public function customize_register( $wp_customize ) {
    ...
    gp_locate_template( 'functions/customize.php' );
    do_action( 'gp_customize_register' );
  ...
  public function add_section( $wp_customize, $value, $panel = false ) {
    ...
    foreach ( $sections as $section ) {
      ...
      foreach ( $section['settings'] as $setting ) {
        ...
        $setting_name = gp_CUSTOMIZE . '[' . $setting['name'] .']';
        ...
        $wp_customize->add_setting( $setting_name,
          wp_parse_args( $setting, array(
              ...
              'sanitize_callback' => 'gp_sanitize_clean',
            )
          )
        );
