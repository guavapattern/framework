...
$options[]      = array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'title'   => 'Number',
      'default' => '10',
      'after'   => ' <i class="gp-text-muted">$ (dollars)</i>',
    ),
    ...
    array(
      ...
      'title'     => 'Image Select',
      'options'   => array(
        'value-1' => 'http://guavapattern.com/assets/images/placeholder/100x80-2ecc71.gif',
        'value-2' => 'http://guavapattern.com/assets/images/placeholder/100x80-e74c3c.gif',
        'value-3' => 'http://guavapattern.com/assets/images/placeholder/100x80-ffbc00.gif',
        'value-4' => 'http://guavapattern.com/assets/images/placeholder/100x80-3498db.gif',
        'value-5' => 'http://guavapattern.com/assets/images/placeholder/100x80-555555.gif',
      ),
    ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => ' <i class="gp-text-muted">( this option is optional )</i>',
        ),
        ...
        array(
          ...
          'before' => '<i class="gp-text-muted">( important )</i> ',
        ),
        ...
        array(
          ...
          'after' => '<p class="gp-text-info">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="gp-text-muted">There is custom css <strong>style="width: 175px; height: 40px; border-color: #93C054;"</strong></p>',
        ),
        ...
        array(
          ...
          'after'      => '<p class="gp-text-muted">There is custom css <strong>style="width: 100%;"</strong></p>'
        ),
        ...
        array(
          ...
          'after'  => '<p class="gp-text-muted">This Text Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => '<p class="gp-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'before' => '<p class="gp-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="gp-text-muted">custom textarea attribute rows=10</p> ',
        ),
        ...
        array(
          ...
          'after'  => '<p class="gp-text-muted">This Textarea Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'         => '<p class="gp-text-muted"><strong>query_args:</strong> sort_order=desc, sort_column=post_title</p>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="gp-text-muted"><strong>query_args:</strong> post_type=your_post_type_name</div>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="gp-text-muted"><strong>query_args:</strong> post_type=your_post_type_name, taxonomy=your_taxonomy_name</div>',
        ),
        ...
        array(
          ...
          'after'        => '<div class="gp-text-muted"><strong>query_args:</strong> taxonomies=your_taxonomy_name, order=asc, orderby=name</div>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<div class="gp-text-muted">Reference site about Lorem Ipsum, a random Lipsum generator.</div>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => ' <i class="gp-text-muted">(px)</i>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="gp-text-muted">Lets write some description for this icon field.</i>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<p class="gp-text-muted">You can use default value <strong>get_template_directory_uri()</strong>."/images/screenshot-1.png"</p>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'options'      => array(
            'value-1'    => 'http://guavapattern.com/assets/images/placeholder/150x125-2ecc71.gif',
            'value-2'    => 'http://guavapattern.com/assets/images/placeholder/150x125-e74c3c.gif',
            'value-3'    => 'http://guavapattern.com/assets/images/placeholder/150x125-ffbc00.gif',
            'value-4'    => 'http://guavapattern.com/assets/images/placeholder/150x125-3498db.gif',
          ),
        ),
        ...
        array(
          ...
          'options'      => array(
            'value-1'    => 'http://guavapattern.com/assets/images/placeholder/150x125-ffbc00.gif',
            'value-2'    => 'http://guavapattern.com/assets/images/placeholder/150x125-3498db.gif',
            'value-3'    => 'http://guavapattern.com/assets/images/placeholder/150x125-e74c3c.gif',
            'value-4'    => 'http://guavapattern.com/assets/images/placeholder/150x125-2ecc71.gif',
            'value-5'    => 'http://guavapattern.com/assets/images/placeholder/150x125-555555.gif',
          ),
          'default'      => 'value-2'
        ),
        ...
        array(
          ...
          'title'        => 'Image Select (Radio) with Default',
          'options'      => array(
            'value-1'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-2'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-3'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-4'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-5'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-6'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-7'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-8'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
          ),
          'radio'        => true,
          'default'      => 'value-2'
        ),
        ...
        array(
          ...
          'options'      => array(
            'value-1'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-2'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-3'    => 'http://guavapattern.com/assets/images/placeholder/80x80-e74c3c.gif',
            'value-4'    => 'http://guavapattern.com/assets/images/placeholder/80x80-ffbc00.gif',
            'value-5'    => 'http://guavapattern.com/assets/images/placeholder/80x80-3498db.gif',
            'value-6'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2ecc71.gif',
            'value-7'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
            'value-8'    => 'http://guavapattern.com/assets/images/placeholder/80x80-2c3e50.gif',
          ),
          'multi_select' => true,
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="gp-text-warning">This field using debug=true</p>',
          'debug'   => true,
        ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'type'     => 'text',
      'title'    => 'Requried Text',
      'after'    => ' <small class="gp-text-warning">( * required )</small>',
      'default'  => 'lorem ipsum',
      'validate' => 'required',
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Also you can add your own validate from <strong>themename/gp-framework/functions/validate.php</strong>',
    ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'after'    => '<p class="gp-text-muted">This text field sanitized already, without any settings. we are using wordpress core.<br /> for eg. try too add <strong>&lt;p></strong> html tag</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="gp-text-muted">Disabled sanitize for this field (sanitize=false). try too add <strong>&lt;p></strong> html tag so, you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      ...
      'after'    => '<p class="gp-text-muted">This textarea field sanitized already, without any settings. we are using wordpress core.<br /> just allowing this tags wp core $allowedposttags</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="gp-text-muted">Disabled sanitize for this field (sanitize=false). you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Custom Sanitize, Also you can add your own validate from <strong>themename/gp-framework/functions/sanitize.php</strong>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="gp-text-muted">This text field sanitized as slug title (sanitize="title")</p>',
      'sanitize' => 'title',
    ),
...
$options[]           = array(
  ...
  'fields'           => array(
    ...
    array(
      ...
      'options'      => array(
        'green'      => 'http://guavapattern.com/assets/images/placeholder/100x80-2ecc71.gif',
        'red'        => 'http://guavapattern.com/assets/images/placeholder/100x80-e74c3c.gif',
        'yellow'     => 'http://guavapattern.com/assets/images/placeholder/100x80-ffbc00.gif',
        'blue'       => 'http://guavapattern.com/assets/images/placeholder/100x80-3498db.gif',
        'gray'       => 'http://guavapattern.com/assets/images/placeholder/100x80-555555.gif',
      ),
