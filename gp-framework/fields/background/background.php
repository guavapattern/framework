 ...
 *
 */
class GPFramework_Option_background extends GPFramework_Options {
  ...
  public function output() {
    ...
    $button_title   = ( isset( $button_title ) ) ? $button_title : __( 'Upload', 'gp-framework' );
    $frame_title    = ( isset( $frame_title  ) ) ? $frame_title  : __( 'Upload', 'gp-framework' );
    $insert_title   = ( isset( $insert_title ) ) ? $insert_title : __( 'Use Image', 'gp-framework' );

    echo '<div class="gp-field-upload">';
    echo '<input type="text" name="'. $this->element_name( '[image]' ) .'" value="'. $this->value['image'] .'"'. $this->element_class() . $this->element_attributes() .'/>';
    echo '<a href="#" class="button gp-add" data-frame-title="'. $frame_title .'" data-upload-type="'. $upload_type .'" data-insert-title="'. $insert_title .'">'. $button_title .'</a>';
    echo '</div>';

    // background attributes
    echo '<fieldset>';
    echo gp_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
